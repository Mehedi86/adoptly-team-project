    ...
    <div className="px-5 lg:px-20 my-20">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-20">
        ...
        <div className="lg:w-1/2 space-y-5 text-center lg:text-left">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-truculenta">
            Your trusted partner in animal rescue and care.
          </h1>
          <p className="font-rubik text-base sm:text-lg text-[#616161]">
            All they need is a loving home and proper care, and all you need is
            their unconditional love in return.
          </p>
          <p className="font-rubik text-sm sm:text-base text-[#707070]">
            At our shelter, rescued animals receive the care, attention, and
            love they deserve. Every adoption brings joy, companionship, and a
            second chance at life for them.
          </p>
